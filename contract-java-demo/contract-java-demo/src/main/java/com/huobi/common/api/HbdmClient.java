...
public class HbdmClient {
	...
	public static void main(String[] args) throws HttpException, IOException {
		...
		String url_prex = "https://api.huobi.pro";//火币api接口地址https://api.hbdm.com  https://api-aws.huobi.pro
		...
		IHbdmRestApi futureV1 = new HbdmRestApiV1(url_prex, api_key, secret_key);
...
//		// 获取K线数据
//		String historyKline = futureGetV1.futureMarketHistoryKline("btcusdt", "1day","3");
...
//		// 获取用户账户信息
//		String accountInfo = futurePostV1.futureContractAccountInfo("usdt");
//		logger.info("获取用户账户信息" + accountInfo);
//		// 获取用户账户信息 @author zq
//		String accountInfo = futureV1.futureAccountInfo();
//		logger.info("获取用户账户信息" + accountInfo);
//		//获取账户余额 @author zq
//		String AccountBalance = futureV1.futureAccountBalance("7835364");
//		logger.info("获取K线数据" + AccountBalance);
		//获取历史订单信息 @author zq
		String historyOrders = futureV1.futureHistoryOrders("ethusdt",null,"2020-02-12","2020-02-13",null,null,null);
		logger.info("获取历史订单信息" + historyOrders);
